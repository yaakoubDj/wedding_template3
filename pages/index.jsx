...
// Add this inside your ShowInvite component (after the t = useTranslation line)
useEffect(() => {
  const audio = new Audio("/assets/video/song.mp3");
  audio.loop = true;
  audio.volume = 0.5;
  ...
  if (playPromise !== undefined) {
    playPromise.catch(() => {
      // Auto-play was blocked, play on user interaction
      const playOnClick = () => {
        audio.play();
...
const coupleNameFirstStr = coupleNameFormat === 'GROOM_FIRST'
  ...
  return (
    <div>
      <audio autoPlay loop style={{ display: 'none' }}>
        <source src="/assets/video/song.mp3" type="audio/mpeg" />
      </audio>
...
<div style={{ position: "relative", display: "inline-block" }}>
  <img src={logo.footerLogo} height="120" />
  <div style={{
    position: "absolute",
    top: "50%",
    left: "50%",
    ...
    <div className="footer_title">
      <h3 className="title" style={{ fontSize: "0.9rem", margin: 0 }}>
        {coupleNameFirstStr}
      </h3>
    </div>
  </div>
...
<a 
  style={{ color: 'grey' }} 
  href="https://www.instagram.com/yaa___koub__19_"
  target="_blank"
  rel="noopener noreferrer"
>
  Built with&nbsp;<object style={{ height: "0.5rem" }} data="/assets/images/heart.svg" type="image/svg+xml"></object>&nbsp;By Yaakoub
</a>          </small>
        </div>)}
      </footer>
    </div >
